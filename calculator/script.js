// Access DOM elemets of the calculator
...
function addValue(value) {
  if (value === ".") {
    ...
    // Find the index of the last numbr in the expression
    ...
    //Check if this nis the first decimal in the current number or if the expression is empty
    if (
